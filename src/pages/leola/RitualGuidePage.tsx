...
const steps = [
  { n: "01", t: "Warm the skin", b: "After a shower or bath, while skin is still warm and slightly damp, scoop a small dollop of Mango + Kokum Whipped Body Butter." },
  { n: "02", t: "Melt and smooth", b: "Press into skin — pulse points first (wrists, neck, décolleté). The whipped butter softens with body warmth and smooths in silky, never heavy." },
